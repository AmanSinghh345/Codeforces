...
void solve() {
    ...
    int miniG=min(a,c);
    int miniF=min(b,d);
    if(miniG>=miniF) cout<<"Gellyfish"<<"
";
    else cout<<"Flower"<<"
";
    // if(a>d and a>b and c>d) ans="Gellyfish";
    // else if(b>c and b>a and c>d) ans="Flower";
    // else if(a==b){
    //     if(c>d) ans="Gellyfish";
    //     else if(c==d) ans="Gellyfish";
    //     else ans="Flower";
    // }
    // else if(a<c and a<d) ans="Flower";
    // else if(c==d) ans="Gellyfish";
    // else if(b>a and b>c and d>c) ans="Flower";
    // cout<<ans<<endl;
}
 
int32_t main() {
