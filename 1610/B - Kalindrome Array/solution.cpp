...
";
    ...
    while(l<=r)
    {
        ...
        {
            vi temp1=a;
            temp1.erase(remove(temp1.begin(),temp1.end(),a[l]),temp1.end());
            if(isPalindrome(temp1)) f1=true;
            vi temp2=a;
            temp2.erase(remove(temp2.begin(),temp2.end(),a[r]),temp2.end());
            if(isPalindrome(temp2)) f2=true;
            break;
        }
        l++;
        r--;
